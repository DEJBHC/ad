<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link"  icon="download" @click="handleExportXls('其他付款单（无申请）')">导出</a-button>
...
<script>
  ...
  import OtherPaymentModal from "./modules/OtherPayment2920Modal";
  ...
  export default {
    ...
    data () {
      return {
        description: '其他付款(无申请)',
        billReportId: '731380732846190592',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPayment/list/2920",
          ...
          exportXlsUrl: "/finance/finPayment/exportXls/2920",
          importExcelUrl: "finance/finPayment/importExcel/2920",
        },
        dictOptions:{},
      }
    },
