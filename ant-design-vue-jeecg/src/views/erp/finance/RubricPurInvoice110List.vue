<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('采购发票(红冲)登记')">导出</a-button>
    ...
    <bill-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>

<script>
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import BillModal from './modules/RubricPurInvoice110Modal'
  ...
  export default {
    name: "RubricPurInvoice110List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, BillModal},

    data () {
      return {
        description: '采购发票(红冲)登记',
        billReportId: '731661222899658752',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPurInvoice/list/1/0",
          ...
          exportXlsUrl: "/finance/finPurInvoice/exportXls/1/0",
          importExcelUrl: "finance/finPurInvoice/importExcel/1/0",
        },
        dictOptions:{},
      }
    },
