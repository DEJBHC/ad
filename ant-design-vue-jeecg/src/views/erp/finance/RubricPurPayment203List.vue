<template>
  <a-card :bordered="false">
    ...
    <rubric-pur-payment203-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        description: '采购退货退款(红字付款)',
        billReportId: '731379980274806784',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPayment/list/203",
          ...
          exportXlsUrl: "/finance/finPayment/exportXls/203",
          importExcelUrl: "finance/finPayment/importExcel/203",
        },
        dictOptions:{},
      }
    },
