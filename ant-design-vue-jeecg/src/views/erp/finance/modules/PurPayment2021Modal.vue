<template>
  <j-modal
    ...
    <template slot="footer">
      <p style="float: left;">提示：采购付款单生效后自动生成应付核销单！</p>
    ...
    <pur-payment-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import PurPaymentForm from "./PurPayment2021Form";

  export default {
    name: 'PurPayment2021Modal',
    mixins: [BillModalMixin],
    components: {PurPaymentForm},
