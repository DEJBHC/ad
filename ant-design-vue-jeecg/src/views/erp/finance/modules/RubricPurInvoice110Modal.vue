<template>
  <j-modal
    ...
    <bill-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import BillForm from "./RubricPurInvoice110Form";

  export default {
    name: 'RubricPurInvoice110Modal',
