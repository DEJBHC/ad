<template>
  <j-modal
    ...
    <pur-payment-req-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import PurPaymentReqForm from './PurPayment2021ReqForm'
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';

  export default {
    name: 'PurPayment2021ReqModal',
    mixins: [BillModalMixin],
    components: {PurPaymentReqForm},
