<template>
  <j-modal
    ...
    <template slot="footer">
      <p style="float: left;">提示：(红字)销售收款单生效后自动生成(红字)应收核销单！</p>
    ...
    <rubric-sal-receipt1030-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import RubricSalReceipt1030Form from "./RubricSalReceipt1030Form";

  export default {
    name: 'RubricSalReceipt1030Modal',
    mixins: [BillModalMixin],
    components: {RubricSalReceipt1030Form},
