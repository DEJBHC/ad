    ...
    <div>
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-tabs v-model="activeKey" @change="handleChangeTabs">
          <a-tab-pane tab="采购退货出库单" :key="refKeys[1]" :forceRender="true">
            <j-vxe-table
              keep-source
              :ref="refKeys[1]"
              ...
              <template v-if="!disabled" v-slot:toolbarPrefix>
                <a-tooltip :title="!model.supplierId || model.supplierId.length===0 ? '请先选择供应商！':'供应商是弹窗查询参数'"
                  ...
                  <a-button @click="$refs.inPopup.openModal()" icon="plus" type="primary"
                            :disabled="!model.supplierId || model.supplierId.length===0">采购退货出库单</a-button>
                </a-tooltip>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addAfter() {
        this.$refs.billHeader.fillBillNo('fin_cgthtk_bill_no');
      },
