<template>
  <j-modal
    ...
    <payment-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import PaymentForm from "./OtherPrepayment2911Form";

  export default {
    name: 'OtherPrepayment2911Modal',
