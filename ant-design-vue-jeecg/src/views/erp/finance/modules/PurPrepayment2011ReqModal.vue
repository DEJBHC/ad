<template>
  <j-modal
    ...
    <pur-prepayment-req-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import PurPrepaymentReqForm from './PurPrepayment2011ReqForm'
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';

  export default {
    name: 'PurPrepayment2011ReqModal',
    mixins: [BillModalMixin],
    components: {PurPrepaymentReqForm},
