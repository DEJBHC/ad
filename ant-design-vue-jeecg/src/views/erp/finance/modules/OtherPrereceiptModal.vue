<template>
  <j-modal
    ...
    <other-prereceipt-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import OtherPrereceiptForm from './OtherPrereceiptForm';

  export default {
    name: 'OtherPrereceiptModal',
    mixins: [BillModalMixin],
    components: {OtherPrereceiptForm},
