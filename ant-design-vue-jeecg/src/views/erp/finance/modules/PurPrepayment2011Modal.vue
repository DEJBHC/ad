<template>
  <j-modal
    ...
    <pur-prepayment-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin'
  import PurPrepaymentForm from "./PurPrepayment2011Form";

  export default {
    name: 'PurPrepayment2011Modal',
    mixins: [BillModalMixin],
    components: {PurPrepaymentForm},
