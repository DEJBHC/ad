<template>
  <j-modal
    ...
    <template slot="footer">
      <p style="float: left;">提示：销售收款单生效后自动生成应收核销单！</p>
    ...
    <sal-receipt-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import SalReceiptForm from "./SalReceiptForm";

  export default {
    name: 'SalReceiptModal',
    mixins: [BillModalMixin],
    components: {SalReceiptForm},
