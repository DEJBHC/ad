<template>
  <j-modal
    ...
    <sal-prereceipt-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import SalPrereceiptForm from "./SalPrereceiptForm";

  export default {
    name: 'SalPrereceiptModal',
    mixins: [BillModalMixin],
    components: {SalPrereceiptForm},
