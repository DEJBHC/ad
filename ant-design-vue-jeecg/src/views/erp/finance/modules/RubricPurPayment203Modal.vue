<template>
  <j-modal
    ...
    <template slot="footer">
      <p style="float: left;">提示：(红字)采购付款单生效后自动生成(红字)应付核销单！</p>
    ...
    <rubric-pur-payment203-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>
  import { BillModalMixin } from '../../common/mixins/BillModalMixin';
  import RubricPurPayment203Form from "./RubricPurPayment203Form";

  export default {
    name: 'PurPayment203Modal',
    mixins: [BillModalMixin],
    components: {RubricPurPayment203Form},
