<template>
  <a-card :bordered="false">
    ...
    <rubric-sal-receipt1031-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import RubricSalReceipt1031Modal from './modules/RubricSalReceipt1031Modal'
  ...
  export default {
    name: "RubricSalReceipt1031List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, RubricSalReceipt1031Modal},

    data () {
      return {
        description: '销售退货退款(红字收款,有申请)',
        billReportId: '731288344257671168',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceipt/list/1031",
          delete: "/finance/finReceipt/delete",
          deleteBatch: "/finance/finReceipt/deleteBatch",
          close: "/finance/finReceipt/close",
          closeBatch: "/finance/finReceipt/closeBatch",
          unclose: "/finance/finReceipt/unclose",
          uncloseBatch: "/finance/finReceipt/uncloseBatch",
          exportXlsUrl: "/finance/finReceipt/exportXls/1031",
          importExcelUrl: "finance/finReceipt/importExcel/1031",
        },
        dictOptions:{},
      }
    },
