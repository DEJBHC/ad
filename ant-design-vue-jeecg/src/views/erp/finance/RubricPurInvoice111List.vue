<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('采购发票(退货)登记')">导出</a-button>
...
<script>
  ...
  import BillModal from './modules/RubricPurInvoice111Modal'
  ...
  export default {
    name: "RubricPurInvoice111List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, BillModal},

    data () {
      return {
        description: '采购发票(退货)登记',
        billReportId: '747252282392621056',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPurInvoice/list/1/1",
          ...
          exportXlsUrl: "/finance/finPurInvoice/exportXls/1/1",
          importExcelUrl: "finance/finPurInvoice/importExcel/1/1",
        },
        dictOptions:{},
      }
    },
