<template>
  <a-card :bordered="false">
    ...
    <pur-payment-req-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PurPaymentReqModal from './modules/PurPayment2021ReqModal'
  ...
  export default {
    name: "PurPayment2021ReqList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PurPaymentReqModal },

    data () {
      return {
        description: '采购付款申请单',
        billReportId: '730755536548311040',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPaymentReq/list/2021",
          ...
          exportXlsUrl: "/finance/finPaymentReq/exportXls/2021",
          importExcelUrl: "finance/finPaymentReq/importExcel/2021",
