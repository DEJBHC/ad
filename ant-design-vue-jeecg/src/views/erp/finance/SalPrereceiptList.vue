<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('销售预收单')">导出</a-button>
    ...
    <sal-prereceipt-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import SalPrereceiptModal from './modules/SalPrereceiptModal'
  ...
  export default {
    name: "SalPrereceiptList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, SalPrereceiptModal},

    data () {
      return {
        description: '销售预收',
        billReportId: '731277309496832000',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceipt/list/101",
          ...
          exportXlsUrl: "/finance/finReceipt/exportXls/101",
          importExcelUrl: "finance/finReceipt/importExcel/101",
        },
        dictOptions:{},
      }
    },
