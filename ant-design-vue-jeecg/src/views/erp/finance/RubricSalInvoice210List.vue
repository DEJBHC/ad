<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('销售发票(红冲)登记')">导出</a-button>
...
<script>
  ...
  import BillModal from './modules/RubricSalInvoice210Modal'
  ...
  export default {
    name: "RubricSalInvoice210List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, BillModal},

    data () {
      return {
        description: '销售发票(红冲)登记',
        billReportId: '731655311518904320',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finSalInvoice/list/1/0",
          ...
          exportXlsUrl: "/finance/finSalInvoice/exportXls/1/0",
          importExcelUrl: "finance/finSalInvoice/importExcel/1/0",
        },
        dictOptions:{},
      }
    },
