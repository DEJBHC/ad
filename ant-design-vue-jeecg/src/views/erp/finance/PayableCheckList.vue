<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('应付核销单-付款核应付')">导出</a-button>
    ...
    <PayableCheck-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PayableCheckModal from './modules/PayableCheckModal'
  ...
  export default {
    name: "PayableCheckList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PayableCheckModal},
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayableCheck/list/2",
          delete: "/finance/finPayableCheck/delete",
          deleteBatch: "/finance/finPayableCheck/deleteBatch",
          close: "/finance/finPayableCheck/close",
          closeBatch: "/finance/finPayableCheck/closeBatch",
          unclose: "/finance/finPayableCheck/unclose",
          uncloseBatch: "/finance/finPayableCheck/uncloseBatch",
          exportXlsUrl: "/finance/finPayableCheck/exportXls/2",
          importExcelUrl: "/finance/finPayableCheck/importExcel/2",
        },
        dictOptions:{},
      }
    },
