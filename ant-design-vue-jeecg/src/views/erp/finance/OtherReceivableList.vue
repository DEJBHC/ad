<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('其他应收单')">导出</a-button>
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item :disabled="true" key="1" @click=""><a-icon type="delete"/>删除</a-menu-item>
        </a-menu>
    ...
    <other-receivable-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import OtherReceivableModal from './modules/OtherReceivableModal'
  ...
  export default {
    name: "OtherReceivableList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, OtherReceivableModal},

    data () {
      return {
        description: '其他应收',
        billReportId: '731472075366903808',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceivable/list/199",
          delete: "/finance/finReceivable/delete",
          deleteBatch: "/finance/finReceivable/deleteBatch",
          ...
          exportXlsUrl: "/finance/finReceivable/exportXls/199",
          importExcelUrl: "finance/finReceivable/importExcel/199",
        },
        dictOptions:{},
      }
    },
