<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('其他预收款单')">导出</a-button>
    ...
    <other-prereceipt-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import OtherPrereceiptModal from "./modules/OtherPrereceiptModal";
  ...
  export default {
    name: "OtherPrereceiptList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, OtherPrereceiptModal},

    data () {
      return {
        description: '其他预收',
        billReportId: '731285398241456128',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceipt/list/191",
          ...
          exportXlsUrl: "/finance/finReceipt/exportXls/191",
          importExcelUrl: "finance/finReceipt/importExcel/191",
        },
        dictOptions:{},
      }
    },
