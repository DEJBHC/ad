<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('其他预付申请单')">导出</a-button>
    ...
    <payment-req-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PaymentReqModal from './modules/OtherPrepayment2911ReqModal'
  ...
  export default {
    name: "OtherPrepayment2911ReqList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PaymentReqModal },

    data () {
      return {
        description: '其他预付申请单',
        billReportId: '730766308884131840',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPaymentReq/list/2911",
          ...
          exportXlsUrl: "/finance/finPaymentReq/exportXls/2911",
          importExcelUrl: "finance/finPaymentReq/importExcel/2911",
