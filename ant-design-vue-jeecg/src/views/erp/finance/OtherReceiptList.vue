<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('其他收款单')">导出</a-button>
    ...
    <other-receipt-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import OtherReceiptModal from "./modules/OtherReceiptModal";
  ...
  export default {
    ...
    components: {TableColumnsSetter, OtherReceiptModal},

    data () {
      return {
        description: '其他收款',
        billReportId: '731287814156365824',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceipt/list/192",
          ...
          exportXlsUrl: "/finance/finReceipt/exportXls/192",
          importExcelUrl: "finance/finReceipt/importExcel/192",
        },
        dictOptions:{},
      }
    },
