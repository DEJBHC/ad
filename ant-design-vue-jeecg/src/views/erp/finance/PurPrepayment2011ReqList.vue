<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('采购预付申请单')">导出</a-button>
    ...
    <pur-prepayment-req-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PurPrepaymentReqModal from './modules/PurPrepayment2011ReqModal'
  ...
  export default {
    name: "PurPrepayment2011ReqList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PurPrepaymentReqModal },

    data () {
      return {
        description: '采购预付申请',
        billReportId: '730740766952697856',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPaymentReq/list/2011",
          delete: "/finance/finPaymentReq/delete",
          deleteBatch: "/finance/finPaymentReq/deleteBatch",
          close: "/finance/finPaymentReq/close",
          closeBatch: "/finance/finPaymentReq/closeBatch",
          unclose: "/finance/finPaymentReq/unclose",
          uncloseBatch: "/finance/finPaymentReq/uncloseBatch",
          exportXlsUrl: "/finance/finPaymentReq/exportXls/2011",
          importExcelUrl: "finance/finPaymentReq/importExcel/2011",
