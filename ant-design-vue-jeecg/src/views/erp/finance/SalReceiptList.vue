<template>
  <a-card :bordered="false">
    ...
    <sal-receipt-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import SalReceiptModal from './modules/SalReceiptModal'
  ...
  export default {
    ...
    components: {TableColumnsSetter, SalReceiptModal},

    data () {
      return {
        description: '销售收款',
        billReportId: '731287258117484544',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceipt/list/102",
          ...
          exportXlsUrl: "/finance/finReceipt/exportXls/102",
          importExcelUrl: "finance/finReceipt/importExcel/102",
        },
        dictOptions:{},
      }
    },
