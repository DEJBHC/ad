<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('其他预付单（有申请）')">导出</a-button>
    ...
    <payment-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PaymentModal from './modules/OtherPrepayment2911Modal'
  ...
  export default {
    name: "OtherPayment2921List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PaymentModal},

    data () {
      return {
        description: '其他预付(有申请)',
        ...
        url: {
          list: "/finance/finPayment/list/2911",
          ...
          exportXlsUrl: "/finance/finPayment/exportXls/2911",
          importExcelUrl: "finance/finPayment/importExcel/2911",
        },
        dictOptions:{},
      }
    },
