<template>
  <a-card :bordered="false">
    ...
    <pur-payment-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PurPaymentModal from './modules/PurPayment2021Modal'
  ...
  export default {
    name: "PurPayment2021List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PurPaymentModal},

    data () {
      return {
        description: '采购付款(有申请)',
        billReportId: '731378370136027136',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPayment/list/2021",
          ...
          exportXlsUrl: "/finance/finPayment/exportXls/2021",
          importExcelUrl: "finance/finPayment/importExcel/2021",
        },
        dictOptions:{},
      }
    },
