...
<script>
  ...
  import PaymentReqModal from './modules/OtherPayment2921ReqModal'
  ...
  export default {
    ...
    data () {
      return {
        description: '其他付款申请单',
        billReportId: '730768262137950208',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPaymentReq/list/2921",
          ...
          exportXlsUrl: "/finance/finPaymentReq/exportXls/2921",
          importExcelUrl: "finance/finPaymentReq/importExcel/2921",
