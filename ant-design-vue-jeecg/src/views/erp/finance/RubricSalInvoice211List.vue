<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('销售发票(退货)登记')">导出</a-button>
...
<script>
  ...
  import BillModal from './modules/RubricSalInvoice211Modal'
  ...
  export default {
    name: "RubricSalInvoice111List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, BillModal},

    data () {
      return {
        description: '销售发票(退货)登记',
        billReportId: '747247804734025728',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finSalInvoice/list/1/1",
          ...
          exportXlsUrl: "/finance/finSalInvoice/exportXls/1/1",
          importExcelUrl: "finance/finSalInvoice/importExcel/1/1",
        },
        dictOptions:{},
      }
    },
