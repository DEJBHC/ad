<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('销售退货退款(红字收款,有申请)')">导出</a-button>
    ...
    <rubric-sal-receipt1031-req-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import RubricSalReceipt1031ReqModal from "./modules/RubricSalReceipt1031ReqModal";
  ...
  export default {
    name: "RubricSalReceipt1031ReqList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, RubricSalReceipt1031ReqModal },

    data () {
      return {
        description: '销售退货退款(红字收款)申请单',
        billReportId: '730761895557771264',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceiptReq/list/1031",
          delete: "/finance/finReceiptReq/delete",
          deleteBatch: "/finance/finReceiptReq/deleteBatch",
          close: "/finance/finReceiptReq/close",
          closeBatch: "/finance/finReceiptReq/closeBatch",
          unclose: "/finance/finReceiptReq/unclose",
          uncloseBatch: "/finance/finReceiptReq/uncloseBatch",
          exportXlsUrl: "/finance/finReceiptReq/exportXls/1031",
          importExcelUrl: "finance/finReceiptReq/importExcel/1031",
