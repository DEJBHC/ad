<template>
  <a-card :bordered="false">
    ...
    <pur-prepayment-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PurPrepaymentModal from "./modules/PurPrepayment2011Modal";
  ...
  export default {
    name: "PurPrepayment2011List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, PurPrepaymentModal},

    data () {
      return {
        description: '采购预付(有申请)',
        billReportId: '731358154521882624',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPayment/list/2011",
          ...
          exportXlsUrl: "/finance/finPayment/exportXls/2011",
          importExcelUrl: "finance/finPayment/importExcel/2011",
        },
        dictOptions:{},
      }
    },
