<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('销售收款单')">导出</a-button>
    ...
    <rubric-sal-receipt1030-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import RubricSalReceipt1030Modal from './modules/RubricSalReceipt1030Modal'
  ...
  export default {
    ...
    components: {TableColumnsSetter, RubricSalReceipt1030Modal},

    data () {
      return {
        description: '销售退货退款(红字收款,无申请)',
        ...
        url: {
          list: "/finance/finReceipt/list/1030",
          ...
          exportXlsUrl: "/finance/finReceipt/exportXls/1030",
          importExcelUrl: "finance/finReceipt/importExcel/1030",
        },
        dictOptions:{},
      }
    },
