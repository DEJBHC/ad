<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('其他付款单（有申请）')">导出</a-button>
...
<script>
  ...
  import PaymentModal from './modules/OtherPayment2921Modal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/finance/finPayment/list/2921",
          ...
          exportXlsUrl: "/finance/finPayment/exportXls/2921",
          importExcelUrl: "finance/finPayment/importExcel/2921",
        },
        dictOptions:{},
      }
    },
