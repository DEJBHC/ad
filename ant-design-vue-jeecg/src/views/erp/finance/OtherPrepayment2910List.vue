<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link"  icon="download" @click="handleExportXls('其他预付单（无申请）')">导出</a-button>
    ...
    <other-payment-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>

<script>
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import OtherPaymentModal from "./modules/OtherPrepayment2910Modal";
  ...
  export default {
    name: "OtherPayment2920List",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, OtherPaymentModal},

    data () {
      return {
        description: '其他预付(无申请)',
        billReportId: '731377474668900352',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPayment/list/2910",
          delete: "/finance/finPayment/delete",
          deleteBatch: "/finance/finPayment/deleteBatch",
          close: "/finance/finPayment/close",
          closeBatch: "/finance/finPayment/closeBatch",
          unclose: "/finance/finPayment/unclose",
          uncloseBatch: "/finance/finPayment/uncloseBatch",
          exportXlsUrl: "/finance/finPayment/exportXls/2910",
          importExcelUrl: "finance/finPayment/importExcel/2910",
        },
        dictOptions:{},
      }
    },
