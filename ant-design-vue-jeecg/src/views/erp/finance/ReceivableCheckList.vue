<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="4" :lg="6" :md="7" :sm="24">
              <a-form-item label="单据阶段">
                <j-dict-select-tag placeholder="请选择单据阶段" v-model="queryParam.billStage" dictCode="x_bill_stage"/>
              </a-form-item>
            </a-col>
            <a-col :xl="4" :lg="6" :md="7" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('应收核销单-收款核应收')">导出</a-button>
    ...
    <receivable-check-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import ReceivableCheckModal from "./modules/ReceivableCheckModal";
  ...
  export default {
    name: "ReceivableCheckList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, ReceivableCheckModal},

    data () {
      return {
        description: '应收核销',
        billReportId: '731494065406521344',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finReceivableCheck/list/1",
          delete: "/finance/finReceivableCheck/delete",
          deleteBatch: "/finance/finReceivableCheck/deleteBatch",
          close: "/finance/finReceivableCheck/close",
          closeBatch: "/finance/finReceivableCheck/closeBatch",
          unclose: "/finance/finReceivableCheck/unclose",
          uncloseBatch: "/finance/finReceivableCheck/uncloseBatch",
          exportXlsUrl: "/finance/finReceivableCheck/exportXls/1",
          importExcelUrl: "/finance/finReceivableCheck/importExcel/1",
        },
        dictOptions:{},
      }
    },
