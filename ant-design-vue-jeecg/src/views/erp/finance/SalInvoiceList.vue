<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('销售发票登记')">导出</a-button>
    ...
    <SalInvoiceModal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import SalInvoiceModal from './modules/SalInvoiceModal'
  ...
  export default {
    ...
    components: {TableColumnsSetter, SalInvoiceModal},

    data () {
      return {
        description: '销售发票登记',
        billReportId: '731643216639340544',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finSalInvoice/list/0/0",
          delete: "/finance/finSalInvoice/delete",
          deleteBatch: "/finance/finSalInvoice/deleteBatch",
          close: "/finance/finSalInvoice/close",
          closeBatch: "/finance/finSalInvoice/closeBatch",
          unclose: "/finance/finSalInvoice/unclose",
          uncloseBatch: "/finance/finSalInvoice/uncloseBatch",
          exportXlsUrl: "/finance/finSalInvoice/exportXls/0/0",
          importExcelUrl: "finance/finSalInvoice/importExcel/0/0",
        },
        dictOptions:{},
      }
    },
