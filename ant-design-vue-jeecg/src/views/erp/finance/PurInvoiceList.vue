<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="发票类型">
                <j-dict-select-tag v-model="queryParam.invoiceType" dictCode="x_invoice_type" placeholder="请选择发票类型"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="发票号">
                <a-input placeholder="请输入" v-model="queryParam.invoiceNo"/>
              </a-form-item>
            </a-col>
            <a-col :xl="8" :lg="9" :md="10" :sm="24">
              <a-form-item label="开票日期">
                <j-date placeholder="请选择开始" class="query-group-cust" v-model="queryParam.invoiceDate_begin"></j-date>
                <span class="query-group-split-cust"></span>
                <j-date placeholder="请选择结束" class="query-group-cust" v-model="queryParam.invoiceDate_end"></j-date>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('采购发票登记')">导出</a-button>
    ...
    <PurInvoiceModal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PurInvoiceModal from './modules/PurInvoiceModal'
  ...
  export default {
    ...
    components: {TableColumnsSetter, PurInvoiceModal},

    data () {
      return {
        description: '采购发票登记',
        billReportId: '731659813290553344',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/finance/finPurInvoice/list/0/0",
          delete: "/finance/finPurInvoice/delete",
          deleteBatch: "/finance/finPurInvoice/deleteBatch",
          close: "/finance/finPurInvoice/close",
          closeBatch: "/finance/finPurInvoice/closeBatch",
          unclose: "/finance/finPurInvoice/unclose",
          uncloseBatch: "/finance/finPurInvoice/uncloseBatch",
          exportXlsUrl: "/finance/finPurInvoice/exportXls/0/0",
          importExcelUrl: "finance/finPurInvoice/importExcel/0/0",
        },
        dictOptions:{},
      }
    },
