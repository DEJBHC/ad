      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        <a-form-model-item label="上级" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="pid">
          <j-tree-select
            ...
            placeholder=""
            v-model="model.pid"
            dict="bas_warehouse,aux_name,id"
            pidField="pid"
            pidValue="0"
        ...
        <a-form-model-item label="有下级" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="hasChild">
        ...
        <a-form-model-item label="编码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="code">
          <a-input v-model="model.code" placeholder="请输入" @blur="onCodeNameBlur" :disabled="disableSubmit"/>
        </a-form-model-item>
        <a-form-model-item label="名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="name">
          <a-input v-model="model.name" placeholder="请输入" @blur="onCodeNameBlur" :disabled="disableSubmit"/>
        </a-form-model-item>
        <a-form-model-item label="助记名" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="auxName">
          <a-input v-model="model.auxName" placeholder="请输入" :disabled="disableSubmit"/>
        </a-form-model-item>
        <a-form-model-item label="电话" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="phone">
          <a-input v-model="model.phone" placeholder="请输入" :disabled="disableSubmit"/>
        </a-form-model-item>
        ...
        <a-form-model-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="remark">
          <a-input v-model="model.remark" placeholder="请输入" :disabled="disableSubmit"/>
        </a-form-model-item>
      ...
      return {
        ...
        validatorRules: {
          code: [
            ...
            { validator: (rule, value, callback) => validateDuplicateValue('bas_warehouse', 'code', value, this.model.id, callback) }
          ],
          name: [
            { required: true, message: '请输入名称!'},
            { validator: (rule, value, callback) => validateDuplicateValue('bas_warehouse', 'name', value, this.model.id, callback) }
          ],
          auxName: [
            { required: true, message: '请输入助记名!'},
            { validator: (rule, value, callback) => validateDuplicateValue('bas_warehouse', 'aux_name', value, this.model.id, callback) }
          ],
        },
        url: {
          add: "/base/basWarehouse/add",
          edit: "/base/basWarehouse/edit",
        },
        expandedRowKeys:[],
        pidField:"pid"
