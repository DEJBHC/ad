<template>
  <a-drawer
    ...
    destroyOnClose
    :visible="visible">
    <bas-material-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit" normal/>
...
<script>
  import BasMaterialForm from "./BasMaterialForm";
  import {DrawerMixin} from '../../common/mixins/DrawerMixin'
