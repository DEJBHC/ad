  ...
  <a-card :bordered="false">
    ...
    <div>
      <a-table
        ...
        :rowSelection="{selectedRowKeys: selectedRowKeys, columnWidth: 40, onChange: onSelectChange, fixed: true}"
...
<script>
  ...
  export default {
    ...
    components: {BasMaterialCategoryModal},
    ...
    data () {
      return {
        ...
        url: {
          list: "/base/basMaterialCategory/rootList",
          childList: "/base/basMaterialCategory/childList",
          getChildListBatch: "/base/basMaterialCategory/getChildListBatch",
