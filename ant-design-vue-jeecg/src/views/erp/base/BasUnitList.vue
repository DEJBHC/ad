...
<script>
  ...
  import BasUnitModal from './modules/BasUnitModal'
  import { filterObj } from '@/utils/util';

  export default {
    name: "BasUnitList",
    mixins:[JeecgListMixin, ListMixin],
    components: {BasUnitModal},
    ...
    data () {
      return {
        ...
        url: {
          list: "/base/basUnit/rootList",
          childList: "/base/basUnit/childList",
          getChildListBatch: "/base/basUnit/getChildListBatch",
