<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link"  icon="download" @click="handleExportXls('销售退货入库单')">导出</a-button>
    ...
    <rubric-sal-out-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import RubricSalOutModal from './modules/RubricSalOutModal'
  ...
  export default {
    name: "RubricSalOutList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, RubricSalOutModal},

    data () {
      return {
        description: '销售退货入库',
        billReportId: '731102556274339840',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/2011/1",
          importExcelUrl: "stock/stkIo/importExcel/2011/1",
        },
        dictOptions:{},
      }
    },
