<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('采购入库单')">导出</a-button>
    ...
    <purIn-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import PurInModal from './modules/PurInModal'
  ...
  export default {
    ...
    components: { PurInModal, TableColumnsSetter },

    data () {
      return {
        description: '采购入库',
        billReportId: '730940446969999360',
        queryParam: {
          isVoided: 0,
        },
    ...
    created() {
      ...
      this.superFieldList.push({type:'string',value:'supplierId',text:'供应商',dictCode:"bas_supplier,aux_name,id"});
    },
