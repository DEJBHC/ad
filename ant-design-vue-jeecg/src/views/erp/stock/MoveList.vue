<template>
  <a-card :bordered="false">
    ...
    <move-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import MoveModal from "./modules/MoveModal";
  ...
  export default {
    ...
    components: {TableColumnsSetter, MoveModal},

    data () {
      return {
        description: '库存调拨',
        billReportId: '731109320126410752',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/301",
          importExcelUrl: "stock/stkIo/importExcel/301",
        },
        dictOptions:{},
      }
    },
