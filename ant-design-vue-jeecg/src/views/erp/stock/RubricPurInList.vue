<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('采购退货出库单')">导出</a-button>
    ...
    <rubric-pur-in-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import RubricPurInModal from './modules/RubricPurInModal'
  ...
  export default {
    name: "RubricPurInList",
    mixins:[JeecgListMixin, BillListMixin],
    components: {TableColumnsSetter, RubricPurInModal},

    data () {
      return {
        description: '采购退货出库',
        billReportId: '731027265740910592',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/1011/1",
          importExcelUrl: "stock/stkIo/importExcel/1011/1",
        },
        dictOptions:{},
      }
    },
