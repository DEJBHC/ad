<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('库存成本调整单')">导出</a-button>
    ...
    <change-cost-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  import ChangeCostModal from './modules/ChangeCostModal'
  ...
  export default {
    ...
    components: {ChangeCostModal, TableColumnsSetter },

    data () {
      return {
        description: '库存成本调整',
        billReportId: '731112733476171776',
        queryParam: {
          isVoided: 0,
        },
        ...
        columns: [
          ...
          },
          {
            ...
            align:"center",
            dataIndex: 'billDate',
            customRender:function (text) { return !text?"":(text.length>10?text.substr(0,10):text) },
            sorter: true
          },
          {
            title:'单据主题',
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/801",
          importExcelUrl: "stock/stkIo/importExcel/801",
        },
        dictOptions:{},
      }
    },
