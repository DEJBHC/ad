<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link" icon="download" @click="handleExportXls('盘盈入库单')">导出</a-button>
    ...
    <check-in-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    components: {CheckInModal, TableColumnsSetter},

    data () {
      return {
        description: '盘盈入库',
        billReportId: '731047182468952064',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/102",
          importExcelUrl: "stock/stkIo/importExcel/102",
        },
        dictOptions:{},
      }
    },
