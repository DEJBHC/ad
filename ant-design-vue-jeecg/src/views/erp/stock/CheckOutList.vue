<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="link"  icon="download" @click="handleExportXls('盘亏出库单')">导出</a-button>
    ...
    <check-out-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    components: {CheckOutModal, TableColumnsSetter},

    data () {
      return {
        description: '盘亏出库',
        billReportId: '731104393064919040',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/202",
          importExcelUrl: "stock/stkIo/importExcel/202",
        },
        dictOptions:{},
      }
    },
