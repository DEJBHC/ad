<template>
  <a-card :bordered="false">
    ...
    <other-out-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    components: {TableColumnsSetter, OtherOutModal},

    data () {
      return {
        description: '其他出库',
        billReportId: '731106579803058176',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/299",
          importExcelUrl: "stock/stkIo/importExcel/299",
        },
        dictOptions:{},
      }
    },
