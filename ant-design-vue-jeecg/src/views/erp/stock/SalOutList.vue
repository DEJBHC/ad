<template>
  <a-card :bordered="false">
    ...
    <sal-out-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>

<script>
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import SalOutModal from './modules/SalOutModal'
  ...
  export default {
    ...
    components: { TableColumnsSetter, SalOutModal },

    data () {
      return {
        description: '销售出库',
        billReportId: '731088296433463296',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          ...
          exportXlsUrl: "/stock/stkIo/exportXls/201/0",
          importExcelUrl: "stock/stkIo/importExcel/201/0",
        },
        dictOptions: {},
      }
    },
    ...
    created() {
      this.superFieldList.push({type:'int',value:'hasRp',text:'有往来',dictCode:'yn'});
      this.superFieldList.push({type:'string',value:'customerId',text:'客户',dictCode:"bas_customer,aux_name,id"});
    },
