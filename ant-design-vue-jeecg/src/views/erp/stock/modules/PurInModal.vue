<template>
  <j-modal
    ...
    <template slot="footer">
      <p style="float: left;">提示：采购入库单生效后自动生成采购应付单！</p>
    ...
    <pur-in-bill-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>

  import PurInBillForm from './PurInForm'
  import { BillModalMixin } from '../../common/mixins/BillModalMixin'

  export default {
    name: 'PurInModal',
    mixins: [BillModalMixin],
    components: {PurInBillForm},
