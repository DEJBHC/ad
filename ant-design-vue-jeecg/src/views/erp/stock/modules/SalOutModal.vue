<template>
  <j-modal
    ...
    <template slot="footer">
      <p style="float: left;">提示：销售出库单生效后自动生成销售应收单！</p>
    ...
    <sal-out-bill-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"/>
  </j-modal>
</template>

<script>

  import SalOutBillForm from "./SalOutForm";
  import { BillModalMixin } from '../../common/mixins/BillModalMixin'

  export default {
    name: 'PurInModal',
    mixins: [ BillModalMixin ],
    components: { SalOutBillForm },
