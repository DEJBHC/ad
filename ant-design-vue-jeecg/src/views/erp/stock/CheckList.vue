<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="物料分类">
                <j-tree-select v-model="queryParam.materialCategoryId" dict="bas_material_category,name,id"
                               pidValue="0" hasChildField="has_child" placeholder="请选择" />
              </a-form-item>
            </a-col>
    ...
    <div>
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a :disabled="!record.actions.edit" @click="myHandleEdit(record)">录入实存数</a>
    ...
    <check-modal ref="modalForm" @ok="modalFormOk" @print="handlePrint"/>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    components: { TableColumnsSetter, CheckModal },

    data () {
      return {
        description: '库存盘点',
        billReportId: '731117673384816640',
        queryParam: {
          isVoided: 0,
        },
        ...
        url: {
          list: "/stock/stkCheck/list",
          delete: "/stock/stkCheck/delete",
          deleteBatch: "/stock/stkCheck/deleteBatch",
          close: "/stock/stkCheck/close",
          closeBatch: "/stock/stkCheck/closeBatch",
          unclose: "/stock/stkCheck/unclose",
          uncloseBatch: "/stock/stkCheck/uncloseBatch",
          exportXlsUrl: "/stock/stkCheck/exportXls",
          importExcelUrl: "stock/stkCheck/importExcel",
        },
        dictOptions:{},
      }
    },
