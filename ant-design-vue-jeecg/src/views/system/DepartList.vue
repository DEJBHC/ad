    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <!--20220116 cfm add-->
          <a-button title="同步部门到钉钉" @click="syncToDingtalk" type="default">同步到钉钉</a-button>
        </a-row>
...
<script>
  ...
  import {httpAction, deleteAction, getAction} from '@/api/manage' //20221026 cfm add: getAction
  ...
  export default {
    ...
    methods: {
      ...
      syncToDingtalk(){
        var that = this
        getAction('/sys/thirdApp/sync/dingtalk/depart/toApp', {}).then(resp => {
