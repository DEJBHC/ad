...
public class BasSupplier implements Serializable {
	...
	/**供应商分类*/
	@Excel(name = "供应商分类", width = 15, dicCode = "x_supplier_category")
    @Dict(dicCode = "x_supplier_category")
    @ApiModelProperty(value = "供应商分类")
    private java.lang.String supplierCategory;
	/**供应商等级*/
	@Excel(name = "供应商等级", width = 15, dicCode = "x_supplier_level")
    ...
    private java.lang.String receiptBankName;
	/**办款资料行号*/
	@Excel(name = "办款资料行号", width = 15)
    @ApiModelProperty(value = "办款资料行号")
    private java.lang.String receiptBankCode;
	/**办款资料账号*/
	@Excel(name = "办款资料账号", width = 15)
    @ApiModelProperty(value = "办款资料账号")
    private java.lang.String receiptAccount;
	/**收件信息收件人*/
    ...
    private java.lang.String alterSuppliers;
	/**备注*/
